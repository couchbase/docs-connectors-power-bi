...
// tag::install-power-bi-connector[]
...
. Follow https://learn.microsoft.com/en-us/power-bi/connect-data/desktop-connector-extensibility#custom-connectors[Microsoft's guide] on configuring   custom connector.

// end::install-power-bi-connector[]
...
// tag::on-premises-secure-connection[]
...
+
.Locating the server's security certificate
...
// end::on-premises-secure-connection[]
--
