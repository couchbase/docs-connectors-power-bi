...
https://packages.couchbase.com/releases/couchbase-powerbi-connector/1.2/couchbase-powerbi-connector-1.2.mez[Power BI Connector Download]

The supported and tested dependencies of this release are:

* https://packages.couchbase.com/releases/couchbase-odbc-driver/1.2/couchbase-odbc-1.2-win64.msi[couchbase-odbc-1.2-win64.msi]
