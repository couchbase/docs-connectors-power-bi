...
https://packages.couchbase.com/releases/couchbase-powerbi-connector/1.3/couchbase-powerbi-connector-1.3.100.mez[Power BI Connector Download]

The supported and tested dependencies of this release are:

* https://packages.couchbase.com/releases/couchbase-odbc-driver/1.3/couchbase-odbc-1.3.102-win64.msi[couchbase-odbc-1.3-win64.msi]
